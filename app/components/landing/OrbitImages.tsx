...
// React Bits OrbitImages by Dominik Koch (https://x.com/dominikkoch).
// TypeScript + "use client" added (required here); logic and the
// offset-path animation are unchanged. offset-path / transform driven,
// so it is compositor-cheap (no WebGL).
...
export default function OrbitImages({
  ...
  const path = useMemo(() => {
    switch (shape) {
      ...
      case "custom":
        return customPath || generateCirclePath(
          designCenterX,
          designCenterY,
          radius,
        );
