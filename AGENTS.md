...
Read **`BRO_PLAN.md`** in this repo first. It is the source of truth: vision,
...
own `/api/*` route handlers. See `BRO_PLAN.md` §9 for the verified contract.

## design language (see `BRO_PLAN.md` §3)
...
UX bar: **no manual.** It must come naturally. The 8 UX laws in `BRO_PLAN.md` §4
